...
export default function Products() {
  ...
  const load = useCallback(
    async (nextPage = page, nextQuery = q) => {
      setLoading(true);
      try {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center py-6 sm:py-8">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl leading-normal font-bold bg-linear-to-r from-sky-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4 pb-1 animate-fade-in">
