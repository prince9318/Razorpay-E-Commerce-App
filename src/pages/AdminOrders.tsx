    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border-2 border-sky-200 p-12 text-center">
          ...
          <p className="text-gray-500 text-sm mt-1">Orders will appear here when customers checkout.</p>
        </div>
      ) : (
              ...
              <div className="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="font-bold text-gray-900">#{o._id.slice(-6)}</span>
                ...
                <div className="flex items-center gap-3 sm:shrink-0">
                  ...
                  <select
                    className="border-2 border-gray-300 rounded-lg px-4 py-2.5 text-sm font-medium text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 cursor-pointer min-w-[140px]"
                    value={o.orderStatus}
