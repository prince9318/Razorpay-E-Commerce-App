        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center justify-between h-14 sm:h-16">
            <Link to="/" className="flex items-center gap-2.5 group shrink-0">
              <div className="w-9 h-9 bg-linear-to-br from-sky-600 to-indigo-600 rounded-xl flex items-center justify-center transform group-hover:scale-105 transition-transform shadow-md">
                <svg
              ...
              <span className="text-xl font-bold bg-linear-to-r from-sky-600 to-indigo-600 bg-clip-text text-transparent hidden sm:inline">
                SmartCart AI
              </span>
            </Link>
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              >
                ...
                {cart.length > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 sm:top-0 sm:right-0 inline-flex items-center justify-center min-w-5 h-5 px-1 text-xs font-bold bg-sky-600 text-white rounded-full">
              ...
              {user ? (
                <>
                  <NavLink to="/orders" className="hidden sm:inline-flex">
                    Orders
                  </NavLink>
                  {user.role === "admin" && (
                    <>
                  ...
                  <div className="flex items-center gap-2 pl-2 ml-1 sm:ml-2 sm:pl-3 border-l border-gray-200">
                    <div className="h-8 w-8 sm:h-9 sm:w-9 rounded-full bg-linear-to-br from-sky-600 to-indigo-600 text-white flex items-center justify-center font-semibold text-sm shadow-md ring-2 ring-white">
                      {user.name.slice(0, 1).toUpperCase()}
                    </div>
                    <span className="text-sm font-medium text-gray-800 max-w-30 truncate hidden sm:block">
                      {user.name}
                    </span>
                    <button
                      onClick={logout}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link
                    to="/register"
                    className="px-4 py-2 rounded-lg bg-linear-to-r from-sky-600 to-indigo-600 text-white hover:from-sky-700 hover:to-indigo-700 font-medium text-sm shadow-md hover:shadow-lg transition-all"
                  >
                    Register
                  </Link>
                </div>
